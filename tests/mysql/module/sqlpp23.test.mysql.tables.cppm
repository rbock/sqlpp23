...
// clang-format off
// generated by ./scripts/ddl2cpp --path-to-ddl tests/include/sqlpp23/tests/mysql/tables.sql --path-to-module tests/mysql/module/sqlpp23.test.mysql.tables.cppm --namespace test --assume-auto-id --module-name sqlpp23.test.mysql.tables --generate-table-creation-helper
...
export module sqlpp23.test.mysql.tables;
...
(
  ...
  export using TabJson = ::sqlpp::table_t<TabJson_>;
