...
// clang-format off
// generated by ./scripts/ddl2cpp --path-to-ddl tests/include/sqlpp23/tests/postgresql/tables.sql --path-to-module tests/postgresql/module/sqlpp23.test.postgresql.tables.cppm --namespace test --assume-auto-id --module-name sqlpp23.test.postgresql.tables --generate-table-creation-helper
...
export module sqlpp23.test.postgresql.tables;
...
(
  ...
  export using BlobSample = ::sqlpp::table_t<BlobSample_>;
  ...
  export using TabExcept = ::sqlpp::table_t<TabExcept_>;
