...
// clang-format off
// generated by ./scripts/sqlpp23-ddl2cpp --path-to-ddl tests/include/sqlpp23/tests/odbc/tables.sql --path-to-module tests/odbc/modules/sqlpp23.test.odbc.tables.cppm --namespace test --assume-auto-id --module-name sqlpp23.test.odbc.tables --generate-table-creation-helper

#include <optional>
#include <sqlpp23/core/name/create_name_tag.h>

export module sqlpp23.test.odbc.tables;
