...
// clang-format off
// generated by ./scripts/ddl2cpp --path-to-ddl tests/include/sqlpp23/tests/core/tab_department.sql tests/include/sqlpp23/tests/core/tables.sql --path-to-module tests/core/module/sqlpp23.test.core.tables.cppm --module-name=sqlpp23.test.core.tables --namespace test --assume-auto-id
