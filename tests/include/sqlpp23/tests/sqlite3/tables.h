...
// clang-format off
// generated by ./scripts/ddl2cpp --path-to-ddl tests/include/sqlpp23/tests/sqlite3/tables.sql --path-to-header tests/include/sqlpp23/tests/sqlite3/tables.h --namespace test --assume-auto-id --generate-table-creation-helper
