...
// clang-format off
// generated by ./scripts/sqlpp23-ddl2cpp --path-to-ddl tests/include/sqlpp23/tests/core/tables.sql --path-to-header tests/include/sqlpp23/tests/core/tables.h --namespace test --assume-auto-id
