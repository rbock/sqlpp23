...
// clang-format off
// generated by ./scripts/sqlpp23-ddl2cpp --path-to-ddl tests/include/sqlpp23/tests/mysql/tables.sql --path-to-header tests/include/sqlpp23/tests/mysql/tables-using-modules.h --namespace test --assume-auto-id --use-import-sqlpp23 --generate-table-creation-helper
