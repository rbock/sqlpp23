...
// clang-format off
// generated by ./scripts/ddl2cpp --path-to-ddl tests/include/sqlpp23/tests/postgresql/tables.sql --path-to-header tests/include/sqlpp23/tests/postgresql/tables-using-modules.h --namespace test --assume-auto-id --use-import-sqlpp23 --generate-table-creation-helper
