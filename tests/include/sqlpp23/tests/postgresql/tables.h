...
// clang-format off
// generated by ./scripts/sqlpp23-ddl2cpp --path-to-ddl tests/include/sqlpp23/tests/postgresql/tables.sql --path-to-header tests/include/sqlpp23/tests/postgresql/tables.h --namespace test --assume-auto-id --generate-table-creation-helper
