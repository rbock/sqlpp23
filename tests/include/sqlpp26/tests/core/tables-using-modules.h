...
// clang-format off
// generated by ./scripts/sqlpp26-ddl2cpp --path-to-ddl tests/include/sqlpp26/tests/core/tables.sql --path-to-header tests/include/sqlpp26/tests/core/tables-using-modules.h --namespace test --assume-auto-id --use-import-sqlpp26
