...
using ::sqlpp::assert_no_unknown_static_tables_in_limit_t;
using ::sqlpp::assert_no_unknown_static_tables_in_offset_t;
...
using ::sqlpp::assert_no_unknown_tables_in_limit_t;
using ::sqlpp::assert_no_unknown_tables_in_offset_t;
